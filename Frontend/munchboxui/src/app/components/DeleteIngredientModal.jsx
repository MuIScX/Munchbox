...
export default function DeleteIngredientModal({ isOpen, onClose, onConfirm, ingredientName }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white w-full max-w-sm rounded-2xl shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 p-6 text-center">
        ...
        <h3 className="text-xl font-bold italic text-slate-800 mb-2">Delete Ingredient</h3>
        <p className="text-sm text-slate-500 mb-6">
          Are you sure you want to remove <span className="font-bold text-slate-700">"{ingredientName}"</span>? This will permanently delete it from your inventory.
        </p>
