...
export default function DeleteMenuModal({ isOpen, onClose, onConfirm, menuName }) {
      ...
      <div className="bg-white w-full max-w-sm rounded-2xl shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 p-6 text-center">
        ...
        <div className="flex gap-3">
          ...
          <button 
            ...
            className="flex-1 flex justify-center items-center px-4 py-2 bg-red-500 hover:bg-red-600 text-white font-semibold rounded-lg transition-colors"
          >
